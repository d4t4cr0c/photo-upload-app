...
export const UIShowcase: React.FC = () => {
  return (
    <ScrollView className="flex-1 bg-black p-6">
      ...
      <Text className="mb-4 mt-8 text-lg font-semibold text-gray-300">Status Messages (Read-only)</Text>
      ...
      <View className="mb-3 rounded-xl border border-emerald-400/20 bg-emerald-500/10 p-4">
        <View className="flex-row items-center justify-center">
          ...
          <Text className="ml-2 text-lg font-medium text-emerald-400/90">
            ¡Publicación creada!
          </Text>
        </View>
      </View>
      ...
      <View className="mb-3 rounded-xl border border-red-400/25 bg-red-500/12 p-4">
        <View className="flex-row items-center justify-center">
      ...
      <Text className="mb-4 mt-8 text-lg font-semibold text-gray-300">MercadoLibre Action Buttons</Text>
  
      {/* Variation 3: With subtle gradient effect */}
      <TouchableOpacity className="mb-4 rounded-2xl bg-yellow-400 px-6 py-6 shadow-2xl border border-yellow-500/30">
        <View className="flex-row items-center justify-center">
